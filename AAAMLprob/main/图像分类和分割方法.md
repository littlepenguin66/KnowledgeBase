...
![](https://cdn.jsdelivr.net/gh/littlepenguin66/webImage/AAAMLP_page186_image_1.png)
...
![](https://cdn.jsdelivr.net/gh/littlepenguin66/webImage/AAAMLP_page205_image.png)
...
大部分预训练的最先进模型可以在 GitHub 上的 pytorch- pretrainedmodels 资源库中找到：[pytorch- pretrainedmodels](https://github.com/Cadene/pretrained-models.pytorch)。详细讨论这些模型不在本章（和本书）范围之内。既然我们只关注应用，那就让我们看看这样的预训练模型如何用于分割任务。

![](https://cdn.jsdelivr.net/gh/littlepenguin66/webImage/AAAMLP_page206_image.png)
